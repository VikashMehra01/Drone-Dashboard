"""
Orthomosaic mapping engine - pose extraction, pose-graph optimization,
and multi-band blended stitching.

Extracted and adapted from SkyForge's core.py (SkyForce/SkyForge-GCS-Repo/src/backend).
"""
...
class PoseGraphOptimizer:
    ...
    def __init__(
        ...
        # Feature detector
        self.sift = cv2.SIFT_create(nfeatures=int(nfeatures))
